...
public sealed class ParityContractsTests
{
    ...
    public void NewEventPayloads_ExposeWireNameAndTypeInfo()
    {
        ...
        Assert.AreEqual(
            VTubeStudioEventNames.Live2DCubismEditorConnected,
            Live2DCubismEditorConnectedEventPayload.EventName
        );
        Assert.AreEqual(
            VTubeStudioEventNames.ExpressionToggled,
            ExpressionToggledEventPayload.EventName
        );
        Assert.AreEqual(
            VTubeStudioEventNames.ArtMeshTracking,
            ArtMeshTrackingEventPayload.EventName
        );
    ...
    public void ModelClickedEventPayload_DeserializesObjectHits()
    {
        const string json = """
            ...
            """;
        ModelClickedEventPayload? payload = JsonSerializer.Deserialize(
            json,
    ...
    {
        ParameterCreationRequest createReq = new()
        {
            ParameterName = "TestParam01",
            Explanation = "e",
            Min = -50,
            Max = 50,
            DefaultValue = 10,
        };
        ParameterCreationRequest createBack = RoundTrip(
            createReq,
    ...
    public void FolderAndPermissionRecords_RoundTrip()
    {
        ...
        PermissionRequest permReq = RoundTrip(
            new() { RequestedPermission = "LoadCustomImagesAsItems" },
        ...
        PermissionResponse permResp = RoundTrip(
            new()
            {
                ...
                Permissions =
                [
                    new PermissionInfo { Name = "LoadCustomImagesAsItems", Granted = true },
                ],
            },
    ...
    public void EventSubscriptionRequest_OmitsNullEventName()
    {
        string json = JsonSerializer.Serialize(
            new EventSubscriptionRequest { Subscribe = false },
    ...
    public void NdiRecords_RoundTrip()
    {
        ...
        NdiConfigResponse resp = RoundTrip(
            new() { NdiActive = true },
    ...
    public void PostProcessingRecords_RoundTrip()
    {
        ...
        PostProcessingEffectConfig config = new()
        {
        ...
        PostProcessingListResponse listResp = RoundTrip(
            new()
            {
                ...
                [
                    new PostProcessingEffect { EnumId = "ColorGrading", ConfigEntries = [config] },
                ],
            },
        ...
        PostProcessingUpdateRequest updateReq = RoundTrip(
            new()
            {
                ...
                [
                    new PostProcessingValue { ConfigId = "Bloom_Strength", ConfigValue = "1.0" },
                ],
            },
        ...
        PostProcessingUpdateResponse updateResp = RoundTrip(
            new() { ActiveEffectCount = 2 },
    ...
    public void SceneOverlayRecords_RoundTrip()
    {
        SceneColorOverlayInfoResponse resp = RoundTrip(
            new()
            {
                Active = true,
                ColorOverlayR = 206,
                LeftCapturePart = new SceneColorCapturePart { Active = true, ColorR = 243 },
            },
    ...
    public void ItemControlRecords_RoundTrip()
    {
        ...
        ItemAnimationControlResponse animResp = RoundTrip(
            new() { Frame = 3, AnimationPlaying = true },
        ...
        ItemSortRequest sortReq = RoundTrip(
            new()
            {
                ItemInstanceId = "i1",
                FrontOn = true,
                SetFrontOrder = "UseSpecialID",
                WithinModelOrderFront = "FullyInFront",
            },
            VTubeStudioJsonContext.Default.ItemSortRequest
        );
        Assert.AreEqual("FullyInFront", sortReq.WithinModelOrderFront);

        ItemSortResponse sortResp = RoundTrip(
            new() { ModelLoaded = true },
        ...
        ItemPinRequest pinReq = RoundTrip(
            new()
            {
                Pin = true,
                ItemInstanceId = "i1",
                VertexPinType = "Random",
                PinInfo = new ItemPinInfo { Size = 0.33 },
            },
        ...
        ItemPinResponse pinResp = RoundTrip(
            new() { IsPinned = true },
    ...
    public void ArtMeshRecords_RoundTrip()
    {
        ArtMeshListResponse list = RoundTrip(
            new()
            {
                ArtMeshGroups = [new ArtMeshGroup { GroupId = "g1", ArtMeshNames = ["a", "b"] }],
            },
        ...
        ColorTintResponse tint = RoundTrip(
            new() { MatchedArtMeshes = 3 },
        ...
        ArtMeshSelectionResponse selResp = RoundTrip(
            new() { Success = true },
        ...
        ArtMeshAtPositionResponse posResp = RoundTrip(
            new()
            {
                ...
                [
                    ...
                    {
                        ArtMeshOrder = 0,
                        HitInfo = new ArtMeshHitInfo { ArtMeshId = "hair" },
                    },
                ],
            },
    ...
    public void CorrectedModels_RoundTrip()
    {
        CurrentModelResponse current = RoundTrip(
            ...
            {
                ModelLoaded = true,
                ModelPosition = new ModelPosition { PositionX = 0.1, Rotation = 9 },
            },
        ...
        ItemLoadRequest loadReq = RoundTrip(
            new() { FileName = "a.png" },
            ...
            new()
            {
                ...
                [
                    new ExpressionInfo
                    {
                        Name = "e",
                        File = "e.exp3.json",
                        SecondsSinceLastActive = 1.5,
                        UsedInHotkeys = [new ExpressionHotkey { Name = "h" }],
                        Parameters = [new ExpressionParameter { Name = "p", Value = 1 }],
                    },
                ],
            },
    ...
    public void BetaConfigAndOutline_RoundTrip()
    {
        ArtMeshTrackingEventConfig trackingConfig = RoundTrip(
            new()
            {
                ...
                [
                    ...
                    {
                        TrackingPointId = "p",
                        ArtMeshCoords = new ArtMeshTrackingCoords
                        {
                            ModelId = "m",
                            ArtMeshId = "a",
                            VertexId1 = 1,
        ...
        ArtMeshOutlineEventConfig outlineConfig = RoundTrip(
            ...
            {
                Frequency = 15,
                ArtMeshes = [new ArtMeshOutlineEntry { ModelId = "m", ArtMeshId = "a" }],
            },
    ...
    {
        const string toggled =
            """{"modelID":"m1","modelName":"M","isLive2DItem":false,"itemInstanceID":"","justLoaded":false,"expressionFile":"e.exp3.json","expressionName":"e","active":true}""";
        ExpressionToggledEventPayload? toggledPayload = JsonSerializer.Deserialize(
            toggled,
        ...
        const string tracking =
            """{"modelLoaded":true,"modelID":"m1","subscribedPointsCount":1,"foundPointsCount":1,"eventCounter":5,"trackingPoints":[{"trackingPointID":"p","artMeshVisible":true,"position":{"x":0.1,"y":0.2},"rotation":90.0,"size":0.05}]}""";
        ArtMeshTrackingEventPayload? trackingPayload = JsonSerializer.Deserialize(
            tracking,
        ...
        const string outline =
            """{"modelLoaded":true,"modelID":"m1","subscribedArtMeshCount":1,"foundArtMeshCount":1,"eventCounter":9,"artMeshOutlines":[{"artMeshID":"a","artMeshVisible":true,"outlineCount":1,"outlineArea":0.08,"outlinePoints":[{"points":[0.1,0.2]}]}]}""";
        ArtMeshOutlineEventPayload? outlinePayload = JsonSerializer.Deserialize(
            outline,
    ...
    public async Task NewMethods_RequireConnection()
    {
        ...
        await Assert.ThrowsExactlyAsync<InvalidOperationException>(() =>
            client.GetVtsFolderInfoAsync()
        );
        await Assert.ThrowsExactlyAsync<InvalidOperationException>(() =>
            client.RequestPermissionAsync()
        );
        await Assert.ThrowsExactlyAsync<InvalidOperationException>(() =>
            client.CreateParameterAsync(new ParameterCreationRequest { ParameterName = "P" })
        );
        await Assert.ThrowsExactlyAsync<InvalidOperationException>(() =>
            client.DeleteParameterAsync(new ParameterDeletionRequest { ParameterName = "P" })
        );
        await Assert.ThrowsExactlyAsync<InvalidOperationException>(() =>
            client.GetSceneColorOverlayInfoAsync()
        );
        await Assert.ThrowsExactlyAsync<InvalidOperationException>(() =>
            client.GetCurrentModelPhysicsAsync()
        );
        await Assert.ThrowsExactlyAsync<InvalidOperationException>(() =>
            client.MoveItemsAsync(new ItemMoveRequest { ItemsToMove = [] })
        );
        await Assert.ThrowsExactlyAsync<InvalidOperationException>(() =>
            client.UnsubscribeFromAllEventsAsync()
        );
    }
}
