...
public sealed record SceneColorOverlayInfoResponse
{
    ...
    public bool ItemsIncluded { get; init; }

    /// <summary>True captures a window; false captures a screen.</summary>
    [JsonPropertyName("isWindowCapture")]
    public bool IsWindowCapture { get; init; }

    /// <summary>Base brightness (0-100).</summary>
    [JsonPropertyName("baseBrightness")]
    public int BaseBrightness { get; init; }

    /// <summary>Color boost (0-100).</summary>
    [JsonPropertyName("colorBoost")]
    public int ColorBoost { get; init; }
    ...
    [JsonPropertyName("colorOverlayR")]
    public int ColorOverlayR { get; init; }

    /// <summary>Overlay green channel.</summary>
    [JsonPropertyName("colorOverlayG")]
    public int ColorOverlayG { get; init; }

    /// <summary>Overlay blue channel.</summary>
    [JsonPropertyName("colorOverlayB")]
    public int ColorOverlayB { get; init; }

    /// <summary>Average red channel.</summary>
    [JsonPropertyName("colorAvgR")]
    public int ColorAvgR { get; init; }

    /// <summary>Average green channel.</summary>
    [JsonPropertyName("colorAvgG")]
    public int ColorAvgG { get; init; }

    /// <summary>Average blue channel.</summary>
    [JsonPropertyName("colorAvgB")]
    public int ColorAvgB { get; init; }

    /// <summary>Average color of the left capture part.</summary>
    [JsonPropertyName("leftCapturePart")]
    public SceneColorCapturePart? LeftCapturePart { get; init; }

    /// <summary>Average color of the middle capture part.</summary>
    [JsonPropertyName("middleCapturePart")]
    public SceneColorCapturePart? MiddleCapturePart { get; init; }

    /// <summary>Average color of the right capture part.</summary>
    [JsonPropertyName("rightCapturePart")]
    public SceneColorCapturePart? RightCapturePart { get; init; }
}
