...
public sealed record ItemListRequest
{
    ...
    [JsonPropertyName("includeAvailableSpots")]
    public bool IncludeAvailableSpots { get; init; }

    /// <summary>When true (default), the response includes the items currently loaded in the scene.</summary>
    [JsonPropertyName("includeItemInstancesInScene")]
    public bool IncludeItemInstancesInScene { get; init; } = true;

    /// <summary>When true, the response includes the item files available on disk.</summary>
    [JsonPropertyName("includeAvailableItemFiles")]
    public bool IncludeAvailableItemFiles { get; init; }

    /// <summary>Optional - restrict the results to items with this file name.</summary>
    [JsonPropertyName("onlyItemsWithFileName")]
    public string? OnlyItemsWithFileName { get; init; }

    /// <summary>Optional - restrict the results to the item with this instance id.</summary>
    [JsonPropertyName("onlyItemsWithInstanceID")]
    public string? OnlyItemsWithInstanceId { get; init; }
}
...
public sealed record ItemListResponse
{
    ...
    [JsonPropertyName("itemsInSceneCount")]
    public int ItemsInSceneCount { get; init; }

    /// <summary>Maximum number of items that may be loaded at once.</summary>
    [JsonPropertyName("totalItemsAllowedCount")]
    public int TotalItemsAllowedCount { get; init; }

    /// <summary>False when menus or dialogs prevent loading items right now.</summary>
    [JsonPropertyName("canLoadItemsRightNow")]
    public bool CanLoadItemsRightNow { get; init; }
    ...
    public IReadOnlyList<int> AvailableSpots { get; init; } = [];

    /// <summary>The items currently loaded in the scene.</summary>
    [JsonPropertyName("itemInstancesInScene")]
    public IReadOnlyList<ItemInstance> ItemInstancesInScene { get; init; } = [];

    /// <summary>The item files available on disk.</summary>
    [JsonPropertyName("availableItemFiles")]
    public IReadOnlyList<AvailableItemFile> AvailableItemFiles { get; init; } = [];
}
...
public sealed record ItemInstance
{
    ...
    [JsonPropertyName("pinnedToModel")]
    public bool PinnedToModel { get; init; }

    /// <summary>The id of the model the item is pinned to.</summary>
    [JsonPropertyName("pinnedModelID")]
    public string? PinnedModelId { get; init; }

    /// <summary>The id of the ArtMesh the item is pinned to.</summary>
    [JsonPropertyName("pinnedArtMeshID")]
    public string? PinnedArtMeshId { get; init; }
    ...
    [JsonPropertyName("fromWorkshop")]
    public bool FromWorkshop { get; init; }
}
...
public sealed record ItemLoadRequest
{
    ...
    public double FadeTime { get; init; }
    ...
    [JsonPropertyName("failIfOrderTaken")]
    public bool FailIfOrderTaken { get; init; }
...
public sealed record ItemUnloadRequest
{
    ...
    [JsonPropertyName("unloadAllInScene")]
    public bool UnloadAllInScene { get; init; }

    /// <summary>When true, unloads all items that were loaded by this plugin.</summary>
    [JsonPropertyName("unloadAllLoadedByThisPlugin")]
    public bool UnloadAllLoadedByThisPlugin { get; init; }

    /// <summary>When true, also allows unloading items loaded by the user or other plugins.</summary>
    [JsonPropertyName("allowUnloadingItemsLoadedByUserOrOtherPlugins")]
    public bool AllowUnloadingItemsLoadedByUserOrOtherPlugins { get; init; }
...
public sealed record ItemUnloadResponse
{
    ...
    [JsonPropertyName("unloadedItems")]
    public IReadOnlyList<UnloadedItem> UnloadedItems { get; init; } = [];
}
...
public sealed record ItemAnimationControlRequest
{
    ...
    [JsonPropertyName("setAutoStopFrames")]
    public bool SetAutoStopFrames { get; init; }

    /// <summary>Frame indices the animation stops on.</summary>
    [JsonPropertyName("autoStopFrames")]
    public IReadOnlyList<int> AutoStopFrames { get; init; } = [];

    /// <summary>When true, <see cref="AnimationPlayState"/> is applied.</summary>
    [JsonPropertyName("setAnimationPlayState")]
    public bool SetAnimationPlayState { get; init; }

    /// <summary>True to play, false to stop the animation.</summary>
    [JsonPropertyName("animationPlayState")]
    public bool AnimationPlayState { get; init; }
}
...
public sealed record ItemAnimationControlResponse
{
    ...
    [JsonPropertyName("animationPlaying")]
...
public sealed record ItemMoveRequest
{
    ...
    [JsonPropertyName("itemsToMove")]
    public required IReadOnlyList<ItemMoveInstruction> ItemsToMove { get; init; }
}
...
public sealed record ItemMoveInstruction
{
    ...
    [JsonPropertyName("fadeMode")]
    public string? FadeMode { get; init; }
    ...
    [JsonPropertyName("setFlip")]
    public bool SetFlip { get; init; }
    ...
    [JsonPropertyName("userCanStop")]
    public bool UserCanStop { get; init; }
}
...
public sealed record ItemMoveResponse
{
    ...
    [JsonPropertyName("movedItems")]
    public IReadOnlyList<ItemMoveResult> MovedItems { get; init; } = [];
}
...
public sealed record ItemSortResponse
{
    ...
    [JsonPropertyName("loadedModelHadRequestedFrontLayer")]
    public bool LoadedModelHadRequestedFrontLayer { get; init; }

    /// <summary>True when the requested back layer was found in the loaded model.</summary>
    [JsonPropertyName("loadedModelHadRequestedBackLayer")]
    public bool LoadedModelHadRequestedBackLayer { get; init; }
}
...
public sealed record ItemPinRequest
{
    ...
    [JsonPropertyName("angleRelativeTo")]
    public string? AngleRelativeTo { get; init; }

    /// <summary>How the size is interpreted: <c>RelativeToWorld</c>, <c>RelativeToCurrentItemSize</c>.</summary>
    [JsonPropertyName("sizeRelativeTo")]
    public string? SizeRelativeTo { get; init; }

    /// <summary>How the pin position is interpreted: <c>Provided</c>, <c>Center</c>, <c>Random</c>.</summary>
    [JsonPropertyName("vertexPinType")]
    public string? VertexPinType { get; init; }

    /// <summary>The pin position.</summary>
    [JsonPropertyName("pinInfo")]
    public ItemPinInfo? PinInfo { get; init; }
}
