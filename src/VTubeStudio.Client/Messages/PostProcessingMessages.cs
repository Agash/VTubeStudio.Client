...
public sealed record PostProcessingListRequest
{
    ...
    [JsonPropertyName("fillPostProcessingPresetsArray")]
    public bool FillPostProcessingPresetsArray { get; init; }

    /// <summary>True fills the effects array; the payload can be large.</summary>
    [JsonPropertyName("fillPostProcessingEffectsArray")]
    public bool FillPostProcessingEffectsArray { get; init; }

    /// <summary>Effect ids to include; empty applies no filter.</summary>
    [JsonPropertyName("effectIDFilter")]
    public IReadOnlyList<string> EffectIdFilter { get; init; } = [];
}
...
public sealed record PostProcessingListResponse
{
    ...
    [JsonPropertyName("postProcessingSupported")]
    public bool PostProcessingSupported { get; init; }

    /// <summary>True when post-processing is turned on.</summary>
    [JsonPropertyName("postProcessingActive")]
    public bool PostProcessingActive { get; init; }

    /// <summary>True when an update request can be sent right now.</summary>
    [JsonPropertyName("canSendPostProcessingUpdateRequestRightNow")]
    public bool CanSendPostProcessingUpdateRequestRightNow { get; init; }

    /// <summary>True when the user allowed restricted effects.</summary>
    [JsonPropertyName("restrictedEffectsAllowed")]
    public bool RestrictedEffectsAllowed { get; init; }

    /// <summary>True when a preset is active.</summary>
    [JsonPropertyName("presetIsActive")]
    public bool PresetIsActive { get; init; }
    ...
    [JsonPropertyName("activeEffectCount")]
    public int ActiveEffectCount { get; init; }

    /// <summary>Effect count before filtering.</summary>
    [JsonPropertyName("effectCountBeforeFilter")]
    public int EffectCountBeforeFilter { get; init; }

    /// <summary>Config count before filtering.</summary>
    [JsonPropertyName("configCountBeforeFilter")]
    public int ConfigCountBeforeFilter { get; init; }

    /// <summary>Effect count after filtering.</summary>
    [JsonPropertyName("effectCountAfterFilter")]
    public int EffectCountAfterFilter { get; init; }

    /// <summary>Config count after filtering.</summary>
    [JsonPropertyName("configCountAfterFilter")]
    public int ConfigCountAfterFilter { get; init; }

    /// <summary>The effects.</summary>
    [JsonPropertyName("postProcessingEffects")]
    public IReadOnlyList<PostProcessingEffect> PostProcessingEffects { get; init; } = [];

    /// <summary>The preset names.</summary>
    [JsonPropertyName("postProcessingPresets")]
    public IReadOnlyList<string> PostProcessingPresets { get; init; } = [];
}
...
public sealed record PostProcessingEffect
{
    ...
    [JsonPropertyName("effectIsActive")]
    public bool EffectIsActive { get; init; }

    /// <summary>True when the effect is restricted.</summary>
    [JsonPropertyName("effectIsRestricted")]
    public bool EffectIsRestricted { get; init; }

    /// <summary>The configs of the effect.</summary>
    [JsonPropertyName("configEntries")]
    public IReadOnlyList<PostProcessingEffectConfig> ConfigEntries { get; init; } = [];
}
...
public sealed record PostProcessingEffectConfig
{
    ...
    [JsonPropertyName("activationConfig")]
    public bool ActivationConfig { get; init; }
    ...
    [JsonPropertyName("colorDefault")]
    public string? ColorDefault { get; init; }

    /// <summary>True when the color carries alpha.</summary>
    [JsonPropertyName("colorHasAlpha")]
    public bool ColorHasAlpha { get; init; }
    ...
    [JsonPropertyName("stringDefault")]
    public string? StringDefault { get; init; }

    /// <summary>Scene item value.</summary>
    [JsonPropertyName("sceneItemValue")]
    public string? SceneItemValue { get; init; }

    /// <summary>Scene item default.</summary>
    [JsonPropertyName("sceneItemDefault")]
    public string? SceneItemDefault { get; init; }
}
...
public sealed record PostProcessingUpdateRequest
{
    ...
    [JsonPropertyName("postProcessingOn")]
    public bool PostProcessingOn { get; init; }

    /// <summary>True loads the preset in <see cref="PresetToSet"/>.</summary>
    [JsonPropertyName("setPostProcessingPreset")]
    public bool SetPostProcessingPreset { get; init; }

    /// <summary>True applies <see cref="PostProcessingValues"/>.</summary>
    [JsonPropertyName("setPostProcessingValues")]
    public bool SetPostProcessingValues { get; init; }

    /// <summary>Preset name without file extension.</summary>
    [JsonPropertyName("presetToSet")]
    public string? PresetToSet { get; init; }

    /// <summary>Fade duration in seconds (0-2).</summary>
    [JsonPropertyName("postProcessingFadeTime")]
    public double PostProcessingFadeTime { get; init; }

    /// <summary>True resets unmentioned values to their defaults.</summary>
    [JsonPropertyName("setAllOtherValuesToDefault")]
    public bool SetAllOtherValuesToDefault { get; init; }

    /// <summary>True allows restricted effects.</summary>
    [JsonPropertyName("usingRestrictedEffects")]
    public bool UsingRestrictedEffects { get; init; }

    /// <summary>True randomizes all configs, ignoring values and presets.</summary>
    [JsonPropertyName("randomizeAll")]
    public bool RandomizeAll { get; init; }

    /// <summary>Randomization chaos level (0-1).</summary>
    [JsonPropertyName("randomizeAllChaosLevel")]
    public double RandomizeAllChaosLevel { get; init; }

    /// <summary>Config values to set.</summary>
    [JsonPropertyName("postProcessingValues")]
    public IReadOnlyList<PostProcessingValue> PostProcessingValues { get; init; } = [];
}
