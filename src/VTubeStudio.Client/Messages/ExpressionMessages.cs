...
public sealed record ExpressionStateResponse
{
    ...
    public IReadOnlyList<ExpressionInfo> Expressions { get; init; } = [];
}
...
public sealed record ExpressionInfo
{
    ...
    [JsonPropertyName("deactivateWhenKeyIsLetGo")]
    public bool DeactivateWhenKeyIsLetGo { get; init; }

    /// <summary>True when the expression is configured to auto-deactivate after a number of seconds.</summary>
    [JsonPropertyName("autoDeactivateAfterSeconds")]
    public bool AutoDeactivateAfterSeconds { get; init; }
    ...
    [JsonPropertyName("secondsSinceLastActive")]
    public double SecondsSinceLastActive { get; init; }

    /// <summary>Hotkeys using the expression; empty unless requested with details.</summary>
    [JsonPropertyName("usedInHotkeys")]
    public IReadOnlyList<ExpressionHotkey> UsedInHotkeys { get; init; } = [];

    /// <summary>Live2D parameter targets of the expression; empty unless requested with details.</summary>
    [JsonPropertyName("parameters")]
    public IReadOnlyList<ExpressionParameter> Parameters { get; init; } = [];
}
...
public sealed record ExpressionActivationRequest
{
    ...
    [JsonPropertyName("expressionFile")]
    public required string ExpressionFile { get; init; }
