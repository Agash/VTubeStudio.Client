...
public sealed record GetCurrentModelPhysicsResponse
{
    ...
    [JsonPropertyName("modelHasPhysics")]
    public bool ModelHasPhysics { get; init; }

    /// <summary>True when the user enabled physics for the model.</summary>
    [JsonPropertyName("physicsSwitchedOn")]
    public bool PhysicsSwitchedOn { get; init; }

    /// <summary>True when the legacy physics toggle is on.</summary>
    [JsonPropertyName("usingLegacyPhysics")]
    public bool UsingLegacyPhysics { get; init; }

    /// <summary>Physics FPS setting; -1 means same FPS as the app.</summary>
    [JsonPropertyName("physicsFPSSetting")]
    public int PhysicsFpsSetting { get; init; }
    ...
    [JsonPropertyName("baseWind")]
    public int BaseWind { get; init; }

    /// <summary>True when a plugin currently overrides physics settings.</summary>
    [JsonPropertyName("apiPhysicsOverrideActive")]
    public bool ApiPhysicsOverrideActive { get; init; }

    /// <summary>The name of the overriding plugin.</summary>
    [JsonPropertyName("apiPhysicsOverridePluginName")]
    public string? ApiPhysicsOverridePluginName { get; init; }

    /// <summary>The physics groups of the model.</summary>
    [JsonPropertyName("physicsGroups")]
    public IReadOnlyList<PhysicsGroup> PhysicsGroups { get; init; } = [];
}
...
public sealed record PhysicsGroup
{
    ...
    public double StrengthMultiplier { get; init; }

    /// <summary>Wind multiplier (0-2).</summary>
    [JsonPropertyName("windMultiplier")]
    public double WindMultiplier { get; init; }
}
...
public sealed record SetCurrentModelPhysicsRequest
{
    ...
    [JsonPropertyName("strengthOverrides")]
    public IReadOnlyList<PhysicsOverride> StrengthOverrides { get; init; } = [];

    /// <summary>Wind overrides.</summary>
    [JsonPropertyName("windOverrides")]
    public IReadOnlyList<PhysicsOverride> WindOverrides { get; init; } = [];
}
...
public sealed record PhysicsOverride
{
    ...
    [JsonPropertyName("setBaseValue")]
    public bool SetBaseValue { get; init; }

    /// <summary>Seconds the override lasts (0.5-5).</summary>
    [JsonPropertyName("overrideSeconds")]
    public double OverrideSeconds { get; init; }
}
