...
public sealed record StatisticsResponse
{
    ...
    /// <summary>The VTube Studio version string.</summary>
    [JsonPropertyName("vTubeStudioVersion")]
    public string? VTubeStudioVersion { get; init; }

    /// <summary>Number of plugins the user has authorised.</summary>
    [JsonPropertyName("allowedPlugins")]
    public int AllowedPlugins { get; init; }

    /// <summary>Number of plugins currently connected.</summary>
    [JsonPropertyName("connectedPlugins")]
    public int ConnectedPlugins { get; init; }

    /// <summary>True when VTube Studio was launched via Steam.</summary>
    [JsonPropertyName("startedWithSteam")]
    public bool StartedWithSteam { get; init; }
    ...
    [JsonPropertyName("windowIsFullscreen")]
    public bool WindowIsFullscreen { get; init; }
}
...
public sealed record VtsFolderInfoResponse
{
    ...
    public string? Backgrounds { get; init; }
