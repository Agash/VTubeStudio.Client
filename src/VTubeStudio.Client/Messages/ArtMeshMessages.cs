...
public sealed record ArtMeshListResponse
{
    ...
    [JsonPropertyName("numberOfArtMeshNames")]
    public int NumberOfArtMeshNames { get; init; }

    /// <summary>Total number of distinct ArtMesh tags in the model.</summary>
    [JsonPropertyName("numberOfArtMeshTags")]
    public int NumberOfArtMeshTags { get; init; }

    /// <summary>The ArtMesh identifiers (names) in the model.</summary>
    [JsonPropertyName("artMeshNames")]
    public IReadOnlyList<string> ArtMeshNames { get; init; } = [];

    /// <summary>The distinct tags applied to ArtMeshes in the model.</summary>
    [JsonPropertyName("artMeshTags")]
    public IReadOnlyList<string> ArtMeshTags { get; init; } = [];

    /// <summary>Total number of ArtMesh groups in the model.</summary>
    [JsonPropertyName("numberOfArtMeshGroups")]
    public int NumberOfArtMeshGroups { get; init; }

    /// <summary>The ArtMesh groups set up for the model.</summary>
    [JsonPropertyName("artMeshGroups")]
    public IReadOnlyList<ArtMeshGroup> ArtMeshGroups { get; init; } = [];
}
...
public sealed record ArtMeshGroup
{
    ...
    [JsonPropertyName("numberOfArtMeshesInGroup")]
    public int NumberOfArtMeshesInGroup { get; init; }
...
public sealed record ColorTintRequest
{
    ...
    public required ColorTint ColorTint { get; init; }

    /// <summary>Selects which ArtMeshes the tint is applied to.</summary>
    [JsonPropertyName("artMeshMatcher")]
    public required ArtMeshMatcher ArtMeshMatcher { get; init; }
}
...
public sealed record ColorTint
{
    ...
    public required int ColorR { get; init; }

    /// <summary>Green channel (0-255).</summary>
    [JsonPropertyName("colorG")]
    public required int ColorG { get; init; }
    ...
    public int ColorA { get; init; } = 255;

    /// <summary>How strongly the tint mixes with the scene lighting color (0-1); defaults to 1.</summary>
    [JsonPropertyName("mixWithSceneLightingColor")]
    public double MixWithSceneLightingColor { get; init; } = 1d;
}
...
public sealed record ColorTintResponse
{
    ...
    [JsonPropertyName("matchedArtMeshes")]
    public int MatchedArtMeshes { get; init; }
}
...
public sealed record ArtMeshHit
{
    ...
    [JsonPropertyName("artMeshOrder")]
    public int ArtMeshOrder { get; init; }
    ...
    [JsonPropertyName("hitInfo")]
    public ArtMeshHitInfo? HitInfo { get; init; }
}
...
public sealed record ArtMeshSelectionRequest
{
    ...
    [JsonPropertyName("textOverride")]
    public string? TextOverride { get; init; }

    /// <summary>Override for the help text shown from the selection list.</summary>
    [JsonPropertyName("helpOverride")]
    public string? HelpOverride { get; init; }

    /// <summary>How many ArtMeshes the user must select; 0 or less means any number.</summary>
    [JsonPropertyName("requestedArtMeshCount")]
    public int RequestedArtMeshCount { get; init; }

    /// <summary>ArtMesh ids to pre-activate in the list.</summary>
    [JsonPropertyName("activeArtMeshes")]
    public IReadOnlyList<string> ActiveArtMeshes { get; init; } = [];
}
...
public sealed record ArtMeshSelectionResponse
{
    ...
    [JsonPropertyName("inactiveArtMeshes")]
    public IReadOnlyList<string> InactiveArtMeshes { get; init; } = [];
}
...
public sealed record ArtMeshAtPositionRequest
{
    ...
    public double Visualize { get; init; }
}
...
public sealed record ArtMeshAtPositionResponse
{
    ...
    [JsonPropertyName("modelWasHit")]
    public bool ModelWasHit { get; init; }

    /// <summary>The checked position.</summary>
    [JsonPropertyName("checkedPosition")]
    public ArtMeshPosition? CheckedPosition { get; init; }

    /// <summary>The VTube Studio window size in pixels.</summary>
    [JsonPropertyName("windowSize")]
    public ArtMeshWindowSize? WindowSize { get; init; }

    /// <summary>Number of ArtMeshes at the checked position.</summary>
    [JsonPropertyName("artMeshHitCount")]
    public int ArtMeshHitCount { get; init; }
