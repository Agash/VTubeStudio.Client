...
public sealed record CurrentModelResponse
{
    ...
    public required bool ModelLoaded { get; init; }
    ...
    [JsonPropertyName("vtsModelName")]
    public string? VtsModelName { get; init; }

    /// <summary>The model's icon file name (empty when the model has no icon).</summary>
    [JsonPropertyName("vtsModelIconName")]
    public string? VtsModelIconName { get; init; }

    /// <summary>The underlying Live2D model (<c>.model3.json</c>) file name.</summary>
    [JsonPropertyName("live2DModelName")]
    public string? Live2DModelName { get; init; }

    /// <summary>Time it took to load the model, in milliseconds.</summary>
    [JsonPropertyName("modelLoadTime")]
    public long ModelLoadTime { get; init; }

    /// <summary>Milliseconds elapsed since the model was loaded.</summary>
    [JsonPropertyName("timeSinceModelLoaded")]
    public long TimeSinceModelLoaded { get; init; }

    /// <summary>Number of Live2D parameters in the model.</summary>
    [JsonPropertyName("numberOfLive2DParameters")]
    public int NumberOfLive2DParameters { get; init; }

    /// <summary>Number of ArtMeshes in the model.</summary>
    [JsonPropertyName("numberOfLive2DArtmeshes")]
    public int NumberOfLive2DArtmeshes { get; init; }

    /// <summary>True when the model has a physics file.</summary>
    [JsonPropertyName("hasPhysicsFile")]
    public bool HasPhysicsFile { get; init; }

    /// <summary>Number of textures used by the model.</summary>
    [JsonPropertyName("numberOfTextures")]
    public int NumberOfTextures { get; init; }

    /// <summary>Texture resolution in pixels.</summary>
    [JsonPropertyName("textureResolution")]
...
public sealed record AvailableModelsResponse
{
    ...
    [JsonPropertyName("numberOfModels")]
    public int NumberOfModels { get; init; }

    /// <summary>The available models.</summary>
    [JsonPropertyName("availableModels")]
    public IReadOnlyList<AvailableModel> AvailableModels { get; init; } = [];
}
...
public sealed record MoveModelRequest
{
    ...
    public bool ValuesAreRelativeToModel { get; init; }
