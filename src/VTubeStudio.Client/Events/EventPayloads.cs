...
public sealed record ModelLoadedEventPayload : IVTubeStudioEvent<ModelLoadedEventPayload>
{
    ...
    /// <inheritdoc/>
    public static JsonTypeInfo<ModelLoadedEventPayload> JsonTypeInfo =>
...
public sealed record TrackingStatusChangedEventPayload
    : IVTubeStudioEvent<TrackingStatusChangedEventPayload>
{
    /// <inheritdoc/>
    public static string EventName => VTubeStudioEventNames.TrackingStatusChanged;

    /// <inheritdoc/>
    public static JsonTypeInfo<TrackingStatusChangedEventPayload> JsonTypeInfo =>
    ...
    [JsonPropertyName("leftHandFound")]
    public bool LeftHandFound { get; init; }

    /// <summary>True when the right hand is currently being tracked.</summary>
    [JsonPropertyName("rightHandFound")]
    public bool RightHandFound { get; init; }
}
...
public sealed record BackgroundChangedEventPayload
    : IVTubeStudioEvent<BackgroundChangedEventPayload>
{
    /// <inheritdoc/>
    public static string EventName => VTubeStudioEventNames.BackgroundChanged;

    /// <inheritdoc/>
    public static JsonTypeInfo<BackgroundChangedEventPayload> JsonTypeInfo =>
        VTubeStudioJsonContext.Default.BackgroundChangedEventPayload;

    /// <summary>The name of the newly selected background.</summary>
    [JsonPropertyName("backgroundName")]
...
public sealed record ModelConfigChangedEventPayload
    : IVTubeStudioEvent<ModelConfigChangedEventPayload>
{
    /// <inheritdoc/>
    public static string EventName => VTubeStudioEventNames.ModelConfigChanged;

    /// <inheritdoc/>
    public static JsonTypeInfo<ModelConfigChangedEventPayload> JsonTypeInfo =>
        VTubeStudioJsonContext.Default.ModelConfigChangedEventPayload;
    ...
    [JsonPropertyName("hotkeyConfigChanged")]
    public bool HotkeyConfigChanged { get; init; }
}
...
public sealed record ModelMovedEventPayload : IVTubeStudioEvent<ModelMovedEventPayload>
{
    ...
    /// <inheritdoc/>
    public static JsonTypeInfo<ModelMovedEventPayload> JsonTypeInfo =>
        VTubeStudioJsonContext.Default.ModelMovedEventPayload;
    ...
    public ModelPosition? ModelPosition { get; init; }
}
...
public sealed record HotkeyTriggeredEventPayload : IVTubeStudioEvent<HotkeyTriggeredEventPayload>
{
    ...
    /// <inheritdoc/>
    public static JsonTypeInfo<HotkeyTriggeredEventPayload> JsonTypeInfo =>
    ...
    [JsonPropertyName("hotkeyFile")]
    public string? HotkeyFile { get; init; }

    /// <summary>True when the hotkey was triggered via the API rather than by the user.</summary>
    [JsonPropertyName("hotkeyTriggeredByAPI")]
    public bool HotkeyTriggeredByApi { get; init; }
    ...
    [JsonPropertyName("isLive2DItem")]
    public bool IsLive2DItem { get; init; }
}
...
public sealed record ModelAnimationEventPayload : IVTubeStudioEvent<ModelAnimationEventPayload>
{
    ...
    /// <inheritdoc/>
    public static JsonTypeInfo<ModelAnimationEventPayload> JsonTypeInfo =>
        VTubeStudioJsonContext.Default.ModelAnimationEventPayload;

    /// <summary>The type of animation event (for example animation start, end, or a custom animation event).</summary>
    [JsonPropertyName("animationEventType")]
    public string? AnimationEventType { get; init; }

    /// <summary>The time within the animation at which the event occurred, in seconds.</summary>
    [JsonPropertyName("animationEventTime")]
    public double AnimationEventTime { get; init; }

    /// <summary>Custom data carried by the animation event, if any.</summary>
    [JsonPropertyName("animationEventData")]
    public string? AnimationEventData { get; init; }
    ...
    [JsonPropertyName("animationLength")]
    public double AnimationLength { get; init; }

    /// <summary>True when the animation is an idle animation.</summary>
    [JsonPropertyName("isIdleAnimation")]
    public bool IsIdleAnimation { get; init; }
...
public sealed record ItemEventPayload : IVTubeStudioEvent<ItemEventPayload>
{
    ...
    /// <inheritdoc/>
    public static JsonTypeInfo<ItemEventPayload> JsonTypeInfo =>
        VTubeStudioJsonContext.Default.ItemEventPayload;

    /// <summary>The type of item event (for example added, removed, dropped, or pinned).</summary>
    [JsonPropertyName("itemEventType")]
    public string? ItemEventType { get; init; }
...
public sealed record ModelClickedEventPayload : IVTubeStudioEvent<ModelClickedEventPayload>
{
    ...
    /// <inheritdoc/>
    public static JsonTypeInfo<ModelClickedEventPayload> JsonTypeInfo =>
        VTubeStudioJsonContext.Default.ModelClickedEventPayload;
    ...
    [JsonPropertyName("loadedModelID")]
    public string? LoadedModelId { get; init; }

    /// <summary>The name of the loaded model.</summary>
    [JsonPropertyName("loadedModelName")]
    public string? LoadedModelName { get; init; }

    /// <summary>True when the click actually hit the model (not empty space).</summary>
    [JsonPropertyName("modelWasClicked")]
    public bool ModelWasClicked { get; init; }

    /// <summary>The mouse button that was used for the click.</summary>
    [JsonPropertyName("mouseButtonID")]
    public int MouseButtonId { get; init; }

    /// <summary>The click position within the window.</summary>
    [JsonPropertyName("clickPosition")]
    public ClickPosition? ClickPosition { get; init; }
    ...
    [JsonPropertyName("clickedArtMeshCount")]
    public int ClickedArtMeshCount { get; init; }

    /// <summary>Details for each ArtMesh hit by the click, topmost first.</summary>
    [JsonPropertyName("artMeshHits")]
    public IReadOnlyList<ArtMeshHit> ArtMeshHits { get; init; } = [];
}
...
public sealed record PostProcessingEventPayload : IVTubeStudioEvent<PostProcessingEventPayload>
{
    ...
    /// <inheritdoc/>
    public static JsonTypeInfo<PostProcessingEventPayload> JsonTypeInfo =>
        VTubeStudioJsonContext.Default.PostProcessingEventPayload;

    /// <summary>True when post-processing is currently switched on.</summary>
    [JsonPropertyName("currentOnState")]
    public bool CurrentOnState { get; init; }
...
public sealed record TestEventPayload : IVTubeStudioEvent<TestEventPayload>
{
    ...
    /// <inheritdoc/>
    public static JsonTypeInfo<TestEventPayload> JsonTypeInfo =>
        VTubeStudioJsonContext.Default.TestEventPayload;

    /// <summary>The message from the subscription config.</summary>
    [JsonPropertyName("yourTestMessage")]
    public string? YourTestMessage { get; init; }
...
public sealed record ModelOutlineEventPayload : IVTubeStudioEvent<ModelOutlineEventPayload>
{
    ...
    /// <inheritdoc/>
    public static JsonTypeInfo<ModelOutlineEventPayload> JsonTypeInfo =>
    ...
    public IReadOnlyList<ClickPosition> ConvexHull { get; init; } = [];

    /// <summary>Center of the outline points.</summary>
    [JsonPropertyName("convexHullCenter")]
    public ClickPosition? ConvexHullCenter { get; init; }
...
public sealed record Live2DCubismEditorConnectedEventPayload
    : IVTubeStudioEvent<Live2DCubismEditorConnectedEventPayload>
{
    /// <inheritdoc/>
    public static string EventName => VTubeStudioEventNames.Live2DCubismEditorConnected;

    /// <inheritdoc/>
    public static JsonTypeInfo<Live2DCubismEditorConnectedEventPayload> JsonTypeInfo =>
        VTubeStudioJsonContext.Default.Live2DCubismEditorConnectedEventPayload;

    /// <summary>True when VTube Studio tries to connect to the editor.</summary>
    [JsonPropertyName("tryingToConnect")]
    public bool TryingToConnect { get; init; }
    ...
    [JsonPropertyName("shouldSendParameters")]
    public bool ShouldSendParameters { get; init; }
}

/// <summary>Payload of an <c>ExpressionToggledEvent</c>: fired when an expression is toggled.</summary>
public sealed record ExpressionToggledEventPayload
    : IVTubeStudioEvent<ExpressionToggledEventPayload>
{
    /// <inheritdoc/>
    public static string EventName => VTubeStudioEventNames.ExpressionToggled;

    /// <inheritdoc/>
    public static JsonTypeInfo<ExpressionToggledEventPayload> JsonTypeInfo =>
        VTubeStudioJsonContext.Default.ExpressionToggledEventPayload;
...
public sealed record ArtMeshTrackingEventPayload : IVTubeStudioEvent<ArtMeshTrackingEventPayload>
{
    ...
    /// <inheritdoc/>
    public static JsonTypeInfo<ArtMeshTrackingEventPayload> JsonTypeInfo =>
        VTubeStudioJsonContext.Default.ArtMeshTrackingEventPayload;
    ...
    [JsonPropertyName("subscribedPointsCount")]
    public int SubscribedPointsCount { get; init; }

    /// <summary>Number of found tracking points.</summary>
    [JsonPropertyName("foundPointsCount")]
    public int FoundPointsCount { get; init; }

    /// <summary>Counter increasing with every event.</summary>
    [JsonPropertyName("eventCounter")]
    public long EventCounter { get; init; }

    /// <summary>The found tracking points.</summary>
    [JsonPropertyName("trackingPoints")]
    public IReadOnlyList<TrackedArtMeshPoint> TrackingPoints { get; init; } = [];
}
...
public sealed record TrackedArtMeshPoint
{
    ...
    [JsonPropertyName("trackingPointID")]
    public string? TrackingPointId { get; init; }

    /// <summary>True when the ArtMesh is currently visible.</summary>
    [JsonPropertyName("artMeshVisible")]
    public bool ArtMeshVisible { get; init; }

    /// <summary>The tracked position.</summary>
    [JsonPropertyName("position")]
    public ClickPosition? Position { get; init; }
...
public sealed record ArtMeshOutlineEventPayload : IVTubeStudioEvent<ArtMeshOutlineEventPayload>
{
    ...
    /// <inheritdoc/>
    public static JsonTypeInfo<ArtMeshOutlineEventPayload> JsonTypeInfo =>
        VTubeStudioJsonContext.Default.ArtMeshOutlineEventPayload;
    ...
    [JsonPropertyName("subscribedArtMeshCount")]
    public int SubscribedArtMeshCount { get; init; }

    /// <summary>Number of found ArtMeshes.</summary>
    [JsonPropertyName("foundArtMeshCount")]
    public int FoundArtMeshCount { get; init; }
    ...
    [JsonPropertyName("artMeshOutlines")]
    public IReadOnlyList<ArtMeshOutline> ArtMeshOutlines { get; init; } = [];
}
...
public sealed record ArtMeshOutline
{
    ...
    [JsonPropertyName("artMeshID")]
    public string? ArtMeshId { get; init; }
    ...
    [JsonPropertyName("outlineCount")]
    public int OutlineCount { get; init; }

    /// <summary>Combined area of the rings in coordinate units.</summary>
    [JsonPropertyName("outlineArea")]
    public double OutlineArea { get; init; }

    /// <summary>The boundary rings.</summary>
    [JsonPropertyName("outlinePoints")]
    public IReadOnlyList<ArtMeshOutlineRing> OutlinePoints { get; init; } = [];
}
